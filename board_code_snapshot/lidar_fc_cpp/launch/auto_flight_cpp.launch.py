...
def generate_launch_description():
    ...
    debug_recorder_node = Node(
        package='lidar_fc_cpp',
        executable='debug_recorder_cpp',
        name='debug_recorder_node',
        output='screen',
        parameters=[{
            'base_dir': '/home/sunrise/project/debug_logs/lidar_fc',
            'lidar_sample_stride': 400,
            'lidar_max_samples_per_frame': 50,
            'summary_freq': 1.0,
        }],
    )
